...
impl<Lang> LatexFmt for KindingDerivation<Lang>
where
    Lang: Language,
    Lang::Type: LatexFmt,
    Lang::Term: LatexFmt,
...
fn derivation_to_bussproofs<Lang>(deriv: &KindingDerivation<Lang>, conf: &mut LatexConfig) -> String
where
    Lang: Language,
    Lang::Type: LatexFmt,
    Lang::Term: LatexFmt,
...
fn derivation_to_frac_array<Lang>(deriv: &KindingDerivation<Lang>, conf: &mut LatexConfig) -> String
where
    Lang: Language,
    Lang::Type: LatexFmt,
    Lang::Term: LatexFmt,
