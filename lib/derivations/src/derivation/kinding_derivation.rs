    ...
    Lang: Language,
{
    ...
    pub fn prim<Ty>(ty: Ty) -> KindingDerivation<Lang>
    where
        Ty: Into<Lang::Type>,
    {
        KindingDerivation {
    ...
    pub fn annotated<Ty>(ty: Ty, knd: Kind) -> KindingDerivation<Lang>
    where
        Ty: Into<Lang::Type>,
    {
        KindingDerivation {
    ...
    pub fn exists<Ty, Deriv>(ty: Ty, knd: Kind, prem: Deriv) -> KindingDerivation<Lang>
    where
        Ty: Into<Lang::Type>,
    ...
    pub fn forall<Ty, Deriv>(ty: Ty, knd: Kind, prem: Deriv) -> KindingDerivation<Lang>
    where
        Ty: Into<Lang::Type>,
        Deriv: Into<Derivation<Lang>>,
    {
    ...
    pub fn op_lam<Ty, Deriv>(ty: Ty, knd: Kind, body_deriv: Deriv) -> KindingDerivation<Lang>
    where
        Ty: Into<Lang::Type>,
        Deriv: Into<Derivation<Lang>>,
    {
    ...
    pub fn record<Ty>(ty: Ty, premises: Vec<Derivation<Lang>>) -> KindingDerivation<Lang>
    where
        Ty: Into<Lang::Type>,
    {
        KindingDerivation {
    ...
    pub fn var(var: &str, knd: Kind) -> KindingDerivation<Lang>
    where
