...
use syntax::{language::Language, terms::Pred, types::Nat};

impl<Lang> GenerateConstraints for Pred<Lang>
where
    Lang: Language,
    ...
    Nat<Lang>: Into<Lang::Type>,
{
    ...
    fn generate_constraints(&self, state: &mut GenState<Lang>) -> Self::Target {
        ...
        state.add_constraint(EqualityConstraint::new(nat.clone(), term_ty));
        nat.into()
    }
}
