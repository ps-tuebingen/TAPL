...
/// Term representing getting the head of a list
...
where
    Lang: Language,
{
    /// Create a new head term with given list, type and span
...
impl<Lang> Spanned for Head<Lang>
where
    Lang: Language,
{
    fn span(&self) -> Span {
...
impl<Lang> FreeVars for Head<Lang>
where
    Lang: Language,
{
...
impl<Lang> FreeTypeVars for Head<Lang>
where
    Lang: Language,
{
